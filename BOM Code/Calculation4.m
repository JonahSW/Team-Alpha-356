function [BoiloffMassatCeres] = Calculation4(a_1,a_2,t_T,total_mass_fraction,M_d,r_tank,number_of_tanks)

% a_1 = 2.766; % Distance from Earth tto Kmo Sun 
...
R = 473; % Radius of Earth in km

D = R + 100; % Radius above Earth in km (orbiting height is value in this equation)
