...
%thetaB_prime is the difference in true anomaly of the departure and arrival (pi for a true hohmann)
...
function [Mratio_A, Mratio_B, deltaV_A, deltaV_B, tT] = elliptic_transfer(a1, a2, thetaB_prime, Isp)
    ...
    V_B_prime = V_B*sqrt(2-(a2/a1)*(1-eT));%Velocity when transfer orbit crosses target orbit
