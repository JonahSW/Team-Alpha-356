...
%...final dimensional derivatives (km/s, rad/s)
r_final = r0*rho_end; %...final dimensional radius
r_dot_final = y(1)*r0*sqrt(mu/r0^3); %...final dimensional radial velocity
theta_dot_final = y(3)*sqrt(mu/r0^3)*1e6; %...final dimensional circumferential velocity
Vf = sqrt(r_dot_final^2+(r_final*theta_dot_final*1e-6)^2); %...final velocity

fprintf('\nFinal Dimensional Derivatives:\n')
fprintf('r_dot_final:   %.5f km/s\n',r_dot_final)
fprintf('theta_dot_final:   %.5f *10^-6 rad/s\n',theta_dot_final)
...
fprintf('Final radial velocity:   %.5f km/s\n',r_dot_final)
fprintf('Final circumferential velocity:   %.5f km/s\n',theta_dot_final*1e-6*r_final)
...
polarplot(th,r1,'-r',theta,rho,'-b',theta_end_thrust,rho_end_thrust,'ro',desired_th,desired_r/r0,'-g',theta_end,rho_end,'co')
%%...end edits........
